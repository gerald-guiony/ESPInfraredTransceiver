...
In this example, I used it to remotely control my Daikin air conditioner using Domoticz or the embedded web server in the ESP.
...
* [ESPInfraredTransceiver](https://github.com/gerald-guiony/ESPInfraredTransceiver) library

## Board settings

Board settings in Arduino IDE to upload the sketch to my Wio Node using OTA (Over-The-Air): [Wio Node board settings](https://github.com/gerald-guiony/ESPInfraredTransceiver/blob/master/examples/IrRemoteControl/doc/WioNodeBoardSettings.png)
